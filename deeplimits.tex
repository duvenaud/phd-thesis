...
\newcommand{\deeplimitsfiguresdir}{deep-limits-figures}
\newcommand{\deeplimitstablesdir}{deep-limits-tables}
...
%\end{tikzpicture}
\end{tabular}
\caption{Feature mapping of a deep \gpt{}. Colors correspond to the location $\vy = \vf(\vx)$ that each point is mapped to after being warped by a deep \gpt{}.  %This figure can be seen as the inverse of figure \ref{fig:filamentation}.  
