...
{
There are two interpretations of deep \gp{}s as neural networks.
...
\end{align}
These models, examined in \cref{sec:deep_kernels}, imply a fixed representation as opposed to a prior over representations, which is what we wish to analyze in this chapter.
