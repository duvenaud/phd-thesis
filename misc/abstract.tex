...
Combining these, we present a procedure which takes a dataset, and outputs an automatically-constructed model, along with plots illustrating the qualitatively different, and potentially novel, types of structure discovered in that dataset.
