...
\begin{figure}
\begin{centering}
\includegraphics[width=\textwidth]{\introfigsdir/post-nosamples}
\end{centering}
\caption[One-dimensional Gaussian process posterior]{A visual representation of a Gaussian process posterior. }
\label{fig:gp-post}
\end{figure}
...
\vf_1(\vx^\star) | \vf(\vx) \sim \mathcal{N}\big( & \vmu_1^\star + \vk_1^{\star\tra} (\vK_1 + \vK_2)\inv \left( \vf - \vmu_1 - \vmu_2 \right) , \\
