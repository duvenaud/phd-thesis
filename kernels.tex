...
A flexible way to model functions having more than one input is to multiply together kernels defined on the individual inputs.
...
Source code to produce all figures is available at \\\url{http://www.github.com/duvenaud/phd-thesis}.
