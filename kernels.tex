...
$\seard$ kernels are the \emph{de facto} default kernel in most applications of \gp{}s.
This is partly because they have relatively few parameters to estimate, and those parameters are relatively interpretable.
...
In general, the more structure we account for in the data, the less data we'll need.
Loosely speaking, the \emph{blessing of abstraction} \citep{goodman2011learning} counters the curse of dimensionality.
...
{By considering only one-dimensional terms of the additive kernel, we can plot the predictive distribution as a function of each dimension seperately.
