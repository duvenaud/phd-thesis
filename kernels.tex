...
\centering
\begin{tabular}{ccc}
True function & Squared-exp \gp{} & Additive \gp{} \\
...
\hspace{-0.1in}\includegraphics[width=0.33\textwidth]{\additivefigsdir/1st_order_censored_add}
\end{tabular}
...
& = \vecop{ \feat(\iva) \otimes \feat(\iva') } \tra \vecop{ \feat(\iva) \otimes \feat(\iva')} 
\end{align}
...
\subsection{Reflective Symmetry along a diagonal}
