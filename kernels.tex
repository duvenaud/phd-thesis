...
\multicolumn{5}{c|}{A sum of two orthogonal} & \multicolumn{1}{c}{Multiplicative} \\
...
A simple example of how multiplication of kernels can give rise to more structure priors is given by changepoint kernels.
