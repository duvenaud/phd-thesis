...
\begin{figure}
\begin{tabular}{cc}
\includegraphics[width=0.33\columnwidth]{\symmetryfigsdir/symmetric-xy-naive-kerne} &
...
\centering
\begin{tabular}{cc}
\hspace{-0.3cm}\includegraphics[width=0.5\columnwidth, clip, trim = 0.17cm 0.05cm 0.9cm 0.3cm]{\deeplimitsfiguresdir/deep_kernel_connected} &
\hspace{-0.5cm}\includegraphics[width=0.5\columnwidth, clip, trim = 0cm 0.1cm 0.9cm 0.35cm]{\deeplimitsfiguresdir/deep_kernel_connected_draws} 
\end{tabular}
