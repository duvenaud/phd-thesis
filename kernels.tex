...
The elements of the group $\gswitch$ containing the operations these functions are invariant to has two elements:%, and is an example of the symmetric group $S2$:
%
\begin{align}
