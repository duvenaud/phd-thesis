...
However, the development of this system highlighted several difficulties with this approach:
...
Second, it was difficult to think of a description for the hyperparameter which controls the heavy-tailedness of the $\kRQ$ kernel.
Third, a product of two $\kRQ$ kernels does not give another $\kRQ$ kernel, which poses the question of how to concisely describe products of $\kRQ$ kernels.
