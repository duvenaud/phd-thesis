...
Combining this procedure with the model search of \cref{ch:grammar} gives a system ombining all the elements of an automatic statistician listed in \cref{sec:ingredients}:
