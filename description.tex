...
\begin{figure}[ht!]
\centering
\includegraphics[trim=0.2cm 18.0cm 8cm 2cm, clip, width=0.8\columnwidth]{\grammarfiguresdir/solarpages/pg_0002-crop}
...
\subsection{Describing Varying Noise Levels in Air Traffic Data}
\label{sec:airline}
...
\end{figure}
%
By multiplying a white noise kernel by a linear kernel, the model is able to express heteroscedasticity (covariance which changes over time).  This component is described in \cref{fig:heteroscedastic}.
%
\begin{figure}[ht!]
\centering
