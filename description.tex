...
Combined with the automatic model-search of \cref{ch:grammar} gives a procedure which can discover and describe a variety of patterns on several time series.
