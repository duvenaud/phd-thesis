...
\chapter{Automatic Model Construction}% Structured Regression Models}
\label{ch:grammar}
...
However, we didn't answer the difficult question of which kernel to use for a given problem.
...
\Cref{table:motifs} lists common regression models that can be expressed by this language.
...
Semi-parametric & $\kLin \kernplus \kSE \kernplus \kWN$ & \citep[e.g.][]{ruppert2003semiparametric} \\
...
Spectral mixture & $\sum \SE \kerntimes \cos \kernplus \kWN$ & \citep{WilAda13} \\
