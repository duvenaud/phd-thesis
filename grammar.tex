...
\begin{tabular}{c}
\hspace{-0.3cm} \includegraphics[width=\wmg,height=\hmg]{\grammarfiguresdir/decomposition/11-Feb-v4-03-mauna2003-s_max_level_0/03-mauna2003-s_all_small} 
\hspace{-0.3cm} \includegraphics[width=\wmg,height=\hmg]{\grammarfiguresdir/decomposition/11-Feb-v4-03-mauna2003-s_max_level_1/03-mauna2003-s_all_small}
\hspace{-0.3cm} \includegraphics[width=\wmg,height=\hmg]{\grammarfiguresdir/decomposition/11-Feb-v4-03-mauna2003-s_max_level_2/03-mauna2003-s_all_small}
\end{tabular}
\caption[Comparison of models found at different deptsh of the kernel search]
...
\begin{tabular}{c}
\hspace{-0.5cm}
\includegraphics[width=0.95\columnwidth,height=7cm]{\grammarfiguresdir/extrapolation_curves/01-airline-s-ex-curve_hint.pdf}
\end{tabular}
