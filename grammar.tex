...
Our method analyzed records of carbon dioxide levels recorded at the Mauna Loa observatory.
...
Long-term trend: $\kLin$ & Yearly periodic: $\kPer \kerntimes \Lin \kerntimes \kSE$ \\
...
Unfortunately, they suffer from the curse of dimensionality: it is difficult for these models to generalize well in more than a few dimensions.
...
We found that the learned structures are often capable of relatively accurate extrapolation in time-series datasets. %, and are competitive with widely used kernel classes on a variety of prediction tasks.
