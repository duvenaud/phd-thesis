...
%The x-axis has the same scale for all plots.
  Left and third columns: base kernels $k(\cdot,0)$.  Second and fourth columns: draws from a \gpt{} with each repective kernel.  The x-axis has the same range on all plots.}
