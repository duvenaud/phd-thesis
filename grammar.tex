...
Many statistical procedures consider all models in a class of fixed size.
For example, graphical model construction algorithms \citep{Friedman03,Eaton07_uai} search over connectivity graphs for a given set of nodes.
