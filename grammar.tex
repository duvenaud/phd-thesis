...
\centering
\begin{tabular}{cc}
\begin{minipage}[t][14cm][t]{0.7\columnwidth}
\newcommand{\treescale}{*1.5\columnwidth}
\begin{tikzpicture}
[sibling distance=0.15\treescale,-,thick, level distance=0.2\treescale]
%\footnotesize
...
\end{tikzpicture}
\end{minipage} &
\newcommand{\wmgt}{0.34\columnwidth}  % width maunu growth tree
