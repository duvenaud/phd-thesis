...
\includegraphics[width=0.2\textwidth]{figures/additive_kernel_sum_p2.pdf} & + & 
\includegraphics[width=0.2\textwidth]{figures/additive_kernel_sum_p1.pdf} &=& 
\includegraphics[width=0.2\textwidth]{figures/additive_kernel.pdf} &
\includegraphics[width=0.2\textwidth]{figures/sqexp_kernel.pdf} \\
...
\includegraphics[width=0.2\textwidth]{figures/additive_kernel_draw_sum_p1.pdf}&+& 
\includegraphics[width=0.2\textwidth]{figures/additive_kernel_draw_sum_p2.pdf}&=&
\includegraphics[width=0.2\textwidth]{figures/additive_kernel_draw_sum.pdf} &
\includegraphics[width=0.2\textwidth]{figures/sqexp_draw.pdf} \\
...
%
%\input{tables/r_concrete_500_hypers_table.tex}
...
\input{tables/all_orders_table.tex}
...
\centering
\begin{tabular}{ccc}
\includegraphics[width=0.3\textwidth]{figures/interpretable_1st_order1.pdf} &
\includegraphics[width=0.3\textwidth]{figures/interpretable_1st_order2.pdf}& 
\includegraphics[width=0.3\textwidth]{figures/interpretable_2nd_order1.pdf}\\
\end{tabular}
...
\hspace{-0.06in} \includegraphics[width=0.23\textwidth]{figures/compare_models/hkl.pdf} \hspace{-0.07in} &
\hspace{-0.06in} \includegraphics[width=0.23\textwidth]{figures/compare_models/gam.pdf} \hspace{-0.07in} &
\hspace{-0.06in} \includegraphics[width=0.23\textwidth]{figures/compare_models/ard.pdf} \hspace{-0.07in} &
\hspace{-0.06in} \includegraphics[height=0.19\textwidth]{figures/compare_models/additive.pdf} \\
...
\centering
\begin{tabular}{cc}
\hspace{-0.25in} \includegraphics[width=0.3\textwidth]{figures/3d_add_kernel_1.pdf} &
\hspace{-0.25in} \includegraphics[width=0.3\textwidth]{figures/3d_add_kernel_2.pdf} \\
1st order interactions & 2nd order interactions \\
$k_1 + k_2 + k_3$ & $k_1k_2 + k_2k_3 + k_1k_3$ \\
\hspace{-0.25in} \includegraphics[width=0.3\textwidth]{figures/3d_add_kernel_3.pdf} & 
\hspace{-0.25in} \includegraphics[width=0.3\textwidth]{figures/3d_add_kernel_321.pdf}\\
...
\centering
\begin{tabular}{cccc}
\hspace{-0.1in}\includegraphics[width=0.24\textwidth]{figures/1st_order_censored_truth.pdf} &
\hspace{-0.1in}\includegraphics[width=0.24\textwidth]{figures/1st_order_censored_ard.pdf}&
\hspace{-0.1in}\includegraphics[width=0.24\textwidth]{figures/1st_order_censored_add.pdf}& 
\hspace{-0.1in}\includegraphics[width=0.24\textwidth]{figures/1st_order_censored_d1d2.pdf}\\ 
True Function & Squared-exp GP & Additive GP & Additive GP \\
 \& data locations & posterior mean & posterior mean & 1st-order functions\\
%\includegraphics[width=0.3\textwidth]{figures/1st_order_censored_data.pdf} &
%\includegraphics[width=0.3\textwidth]{figures/1st_order_censored_d1.pdf}&
%\includegraphics[width=0.3\textwidth]{figures/1st_order_censored_d2.pdf}\\
...
\input{tables/reg_table_mse2.tex}
\input{tables/reg_table_ll2.tex}
\input{tables/class_table2.tex}
\input{tables/class_table_ll2.tex}
