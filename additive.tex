...
\centering
\begin{tabular}{cccc}
\hspace{-0.25in} \includegraphics[width=0.27\textwidth]{\additivefigsdir/3d-kernel/3d_add_kernel_1} &
\hspace{-0.25in} \includegraphics[width=0.27\textwidth]{\additivefigsdir/3d-kernel/3d_add_kernel_2} &
\hspace{-0.25in} \includegraphics[width=0.27\textwidth]{\additivefigsdir/3d-kernel/3d_add_kernel_3} & 
\hspace{-0.25in} \includegraphics[width=0.27\textwidth]{\additivefigsdir/3d-kernel/3d_add_kernel_321}\\
