...
Additive kernels can allow extrapolation far from the training data.
...
\Cref{tbl:all_orders} shows that sometimes intermediate degrees of interaction contribute most of the variance.
