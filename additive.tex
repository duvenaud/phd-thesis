...
\input{\additivetablesdir/all_orders_table_frozen.tex}
...
\cite{shawe2004kernel} introduce a very flexible way of specifying sums of products of kernels, called \textit{graph kernels}. [Should this be in future work?]

\begin{figure}[h]
\centering
\begin{tabular}{cc}
\includegraphics[width=0.5\textwidth]{\additivefigsdir/housing_order_mse.pdf}& 
\includegraphics[width=0.5\textwidth]{\additivefigsdir/housing_order_ll.pdf} \\
Mean Squared Error & Log Likelihood\\
\end{tabular}
\caption{ Likelihood versus order of interaction }
\label{fig:housing}
\end{figure}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.5\textwidth]{\additivefigsdir/synth_plot_1}\\
\end{tabular}
\caption{ ARD vs AS in an irrelevant variables contest. }
\label{fig:housing}
\end{figure}



%Especially good for trying to find the effects of interventions?
